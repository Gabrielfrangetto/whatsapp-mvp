...
app.get('/setup', async (req, res) => {
  ...
  try {
    ...
    if (exists) return res.json({ message: 'Migrations OK, admin já existe', email: exists.email });
    ...
    res.json({ message: '✅ Migrations rodadas e admin criado!', email: agent.email });
  } catch (e) {
