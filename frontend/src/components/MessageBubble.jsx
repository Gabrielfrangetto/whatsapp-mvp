...
export default function MessageBubble({ message, showAvatar, showAgentName, showContactAvatar, contactName, contactProfilePic, onReact, onReply, onScrollToMessage, isHighlighted, onSaveSticker, onFavorite, isFavorited, isChained }) {
  ...
  const coloredBubble = (
    <div style={{ position: 'relative' }}>
      <div style={{ background: isOut ? 'var(--theme-bg-bubble-out)' : 'var(--theme-bg-bubble-in)', borderRadius: isChained ? 8 : isOut ? '8px 0 8px 8px' : '0 8px 8px 8px', padding: isImage ? '4px 4px 5px' : '8px 12px 5px', boxShadow: '0 1px 2px rgba(0,0,0,0.08)', overflow: 'hidden' }}>
