  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
        ...
        <button type="submit" disabled={loading} style={{ padding: '9px 18px', borderRadius: 8, border: 'none', background: 'var(--theme-primary)', color: 'var(--theme-primary-text)', cursor: 'pointer', fontSize: 13, fontWeight: 600 }}>
      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
            ...
            <button onClick={handleSave} disabled={saving} style={{ padding: '9px 18px', borderRadius: 8, border: 'none', background: 'var(--theme-primary)', color: 'var(--theme-primary-text)', cursor: 'pointer', fontSize: 13, fontWeight: 600 }}>
    ...
    <div style={{ flex: 1, background: 'var(--theme-bg)', padding: 32, overflowY: 'auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        ...
        <button
          ...
          style={{ padding: '9px 18px', background: 'var(--theme-primary)', color: 'var(--theme-primary-text)', border: 'none', borderRadius: 10, cursor: 'pointer', fontSize: 13, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6 }}
        >
          + Novo Agente
        </button>
      </div>
