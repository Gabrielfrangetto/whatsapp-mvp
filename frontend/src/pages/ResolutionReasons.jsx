    ...
    <div style={{ marginTop: 32 }}>
      ...
      <form onSubmit={handleAdd} style={{ display: 'flex', gap: 8, marginBottom: 16 }}>
        ...
        <button
          ...
          style={{ padding: '9px 16px', background: 'none', border: `2px solid ${newLabel.trim() ? 'var(--theme-primary)' : 'var(--theme-border)'}`, color: newLabel.trim() ? 'var(--theme-primary)' : 'var(--theme-text-muted)', borderRadius: 8, cursor: newLabel.trim() ? 'pointer' : 'default', fontSize: 13, fontWeight: 600, whiteSpace: 'nowrap' }}
        >
